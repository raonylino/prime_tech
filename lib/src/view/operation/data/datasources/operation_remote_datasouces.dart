...
import 'package:prime_pronta_resposta/src/view/operation/data/model/operation_model.dart';
...
class OperationRemoteDataSourceImpl implements OperationRemoteDataSource {
  ...
  Future<OperationModel> fetchOperationById(int id) async {
    ...
    final operationJson = data.firstWhere((item) => item['id'] == id, orElse: () => null);
